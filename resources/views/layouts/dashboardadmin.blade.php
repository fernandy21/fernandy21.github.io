...
<html lang="en">
    <head>
        ...
        <link href="{{asset('publicadmin/css/bootstrap.min.css')}}" rel="stylesheet">

        <link href="{{asset('publicadmin/fonts/css/font-awesome.min.css')}}" rel="stylesheet">
        <link href="{{asset('publicadmin/css/animate.min.css')}}" rel="stylesheet">

        <!-- Documentation extras -->

        <link href="{{asset('publicadmin/css/docs.min.css')}}" rel="stylesheet">

        <script src="{{asset('publicadmin/js/jquery.min.js')}}"></script>

        <script type="text/javascript" src="{{asset('publicadmin/js/shCore.js')}}"></script>
        <script type="text/javascript" src="{{asset('publicadmin/js/shBrushXml.js')}}"></script>
        <link type="text/css" rel="stylesheet" href="{{asset('publicadmin/css/shCoreDefault.css')}}"/>
