...
<head>
	<title>Clear login Form Responsive Widget</title>
	<!-- Meta-Tags -->
	...
	<!-- //Meta-Tags -->
	<!-- Stylesheets -->
	<link href="{{asset('publiclogin/css/font-awesome.css')}}" rel="stylesheet">
	<link href="{{asset('publiclogin/css/style.css')}}" rel='stylesheet' type='text/css' />
	<!--// Stylesheets -->
	<!--fonts-->
	<!-- title -->
	<!-- body -->
